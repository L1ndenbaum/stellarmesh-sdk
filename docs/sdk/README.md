...
本目录按照仓库中可独立发布和被业务项目引用的 SDK 划分。当前提供四个 Go Module 和两个独立 Python distribution：

- [Go 父 SDK 接入教程](go/README.md)：对应 `sdk/go` Go Module，包含 HTTP、环境配置、Storage 契约和进程内对象存储能力；
